...
Both `src/agentic_portfolio/agents/llm_s_apply.py`'s `apply_rule` (production rule
application) and `src/agentic_portfolio/agents/llm_s/tools.py`'s `TestComplexConditionTool`
