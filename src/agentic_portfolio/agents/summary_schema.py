...
`src/agentic_portfolio/flow/report_summary.py` computes every figure a monthly briefing
...
mechanical: `src/agentic_portfolio/agents/report_summary.py`'s `verify_narrative` replaces
any field containing a figure that was not in the facts it was given.

This mirrors `src/agentic_portfolio/agents/llm_f_schema.py`, where the model estimates a
