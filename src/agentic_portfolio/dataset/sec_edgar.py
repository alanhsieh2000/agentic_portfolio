...
window (see src/agentic_portfolio/dataset/fundamentals.py's module docstring and
...
class SecUserAgentMissingError(RuntimeError):
    """SEC_UA is unset/blank (via agentic_portfolio.config.settings.settings, which loads
...
def _sec_headers() -> dict[str, str]:
    """Reads SEC_UA from agentic_portfolio.config.settings.settings (which loads .env at
